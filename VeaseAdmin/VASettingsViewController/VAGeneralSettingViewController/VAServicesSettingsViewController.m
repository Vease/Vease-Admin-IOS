//
//  VAServicesSettingsViewController.m
//  VeaseAdmin
//
...
#import "VAServicesSettingsViewController.h"

@interface VAServicesSettingsViewController ()
{
...
@implementation VAServicesSettingsViewController
...
- (void)serverDidLoadDataSuccessfully:(NSDictionary *)responce {
    ...
    if (typeID == kResponseGetServices) {
